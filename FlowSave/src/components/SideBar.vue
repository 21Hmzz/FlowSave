                    ...
                    <ul class="pb-2 space-y-2">
                        ...
                        <li>
                            ...
                            <ul id="dropdown-auth" class="hidden py-2 space-y-2">
                                ...
                                <li>
                                    <a href=""
                                        class="flex items-center p-2 text-base text-red-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">
                                ...
                                <div class="inline-flex items-center">
                                    <svg class="h-3.5 w-3.5 rounded-full mr-2" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <g fill-rule="evenodd" stroke-width="1pt">
                                            ...
                                            <path fill="#0000FF" d="M0 0h170.7v512H0z" />
